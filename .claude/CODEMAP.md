...
- `scripts/verifier-depot.sh` : 8 contrôles d'intégrité (dérive versions/, ORDRE, frontmatter, identifiants existants, liens, syntaxe, corpus 12/18 mini, pré-filtre sur le dépôt). Testé par injection de fautes. Exit 1 si un contrôle échoue.
